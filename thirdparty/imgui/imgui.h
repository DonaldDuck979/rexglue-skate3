...
struct ImFontConfig
{
    ...
    float           RasterizerGamma;        // 1.0f     // [rexglue patch] Gamma exponent applied to glyph coverage after baking (out = in^gamma). <1.0f fattens/brightens light-on-dark text to match gamma-aware browser text blending. 1.0f = no change.
