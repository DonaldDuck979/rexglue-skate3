...
REXCVAR_DECLARE(bool, scaled_resolve_texture_loads_from_shared_memory);
...
REXCVAR_DECLARE(int32_t, vulkan_debug_log_resolve_decisions_remaining);
REXCVAR_DECLARE(int32_t, vulkan_debug_log_team_profile_background_candidates_remaining);
REXCVAR_DECLARE(int32_t, vulkan_debug_log_team_profile_background_bindings_remaining);
REXCVAR_DECLARE(int32_t, vulkan_debug_log_team_profile_background_draws_remaining);
REXCVAR_DECLARE(bool, vulkan_sync_after_resolve);
REXCVAR_DECLARE(bool, vulkan_barrier_after_scaled_resolve);
REXCVAR_DECLARE(int32_t, vulkan_readback_resolve_max_length);
REXCVAR_DECLARE(int32_t, vulkan_readback_resolve_min_address);
REXCVAR_DECLARE(int32_t, vulkan_readback_resolve_max_address);
